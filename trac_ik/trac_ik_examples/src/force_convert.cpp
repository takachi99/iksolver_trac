...
// force_convert::force_convert():nh()
// {
//   ros::NodeHandle pnh("~");
...
//     transformStamped.transform.translation.x = current_force.x+0.0 ;
//     transformStamped.transform.translation.y = current_force.y+0.0;
//     transformStamped.transform.translation.z = current_force.z+0.0;
//     tf2::Quaternion q;
//     q.setRPY(0, 0, 0.0);
//     transformStamped.transform.rotation.x = q.x()+0.0;
//     transformStamped.transform.rotation.y = q.y()+0.0;
//     transformStamped.transform.rotation.z = q.z()+0.0;
//     transformStamped.transform.rotation.w = q.w()+0.0;
